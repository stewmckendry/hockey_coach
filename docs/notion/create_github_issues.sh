...
# Run from the docs/notion directory
...
gh issue create \
  ...
  --body-file implementation-implementation-issues/issue_001_initialize_workspace.md \
...
gh issue create \
  ...
  --body-file implementation-issues/issue_002_team_information.md \
...
gh issue create \
  ...
  --body-file implementation-issues/issue_003_teamsnap_integration.md \
...
gh issue create \
  ...
  --body-file implementation-issues/issue_004_skills_library.md \
...
gh issue create \
  ...
  --body-file implementation-issues/issue_005_position_guides.md \
  --label "enhancement,content,notion" \
  --milestone "Phase 2: Education Content"
...
gh issue create \
  ...
  --body-file implementation-issues/issue_006_team_systems.md \
  --label "enhancement,content,notion" \
  --milestone "Phase 2: Education Content"
...
gh issue create \
  ...
  --body-file implementation-issues/issue_007_practice_plan_command.md \
...
gh issue create \
  ...
  --body-file implementation-issues/issue_008_hockey_iq_chatbot.md \
